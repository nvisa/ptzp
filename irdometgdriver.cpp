...
IRDomeTGDriver::IRDomeTGDriver(QObject *parent) : PtzpDriver (parent)
{
...
PtzpHead *IRDomeTGDriver::getHead(int index)
{
	if (index == 0)
		return headModule;
	else if (index == 1)
...
int IRDomeTGDriver::setTarget(const QString &targetUri)
{
...
QVariant IRDomeTGDriver::get(const QString &key)
{
...
int IRDomeTGDriver::set(const QString &key, const QVariant &value)
{

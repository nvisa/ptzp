...
#define sizeof_incoming (sizeof incoming_word)
	...
	while (1) {
		 ...
		 */
		logit(LOG_NOTICE, 0, "%d", ntpc->goodness);
...
int main(int argc, char *argv[])
{
    ...
    logit(LOG_NOTICE, 0, "main starting");
	...
	/* Startup sequence */
    logit(LOG_NOTICE, 0, "setup socket daemonize %d", daemonize);
//	if (daemonize) {
//		if (-1 == daemon(0, 0)) {
